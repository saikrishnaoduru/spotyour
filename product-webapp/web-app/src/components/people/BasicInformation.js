...
function BasicInformation() {
    ...
    const getUserDetailsById = (id) => {
        ...
        var url = "https://spotyourvaccine.stackroute.io/user-service/api/v1/user/user/" + id;
        return fetch(url,
            {
                headers: {
...
function SaveChanges(user) {
    ...
    var url = "https://spotyourvaccine.stackroute.io/user-service/api/v1/user/user/" + user.id;
