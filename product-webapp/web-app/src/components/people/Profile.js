...
function Profile() {
    ...
    const getUserData = () => {
        ...
        let url = "https://spotyourvaccine.stackroute.io/user-service/api/v1/user/user/" + emailPass ;
    ...
    function fetchBookedSlot(data) {
        ...
        let url = "https://spotyourvaccine.stackroute.io/slot-booking-service/api/v1/getByUserEmail/" + emailPass;
