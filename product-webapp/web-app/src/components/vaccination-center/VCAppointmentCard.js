...
import axios from 'axios';
 ...
 function AppointmentCard(props) {
  ...
  let url = "https://spotyourvaccine.stackroute.io/slot-booking-service/api/v1/slot/status/"+slotid+"?status=EXPIRED";
	axios.put(url).then(res=>{
	})
  
  // var url2 = "http://localhost:8080/vaccination-center-service/api/v1/slots/update/"+slotid+"?status=EXPIRED"
  var url2 = "https://spotyourvaccine.stackroute.io/vaccination-center-service/api/v1/slots/update/"+slotid+"?status=EXPIRED"
  ...
  let url = "https://spotyourvaccine.stackroute.io/slot-booking-service/api/v1/slotdelete/"+slotemail;
  ...
  var url2 = "https://spotyourvaccine.stackroute.io/vaccination-center-service/api/v1/slots/"+slotidc;
